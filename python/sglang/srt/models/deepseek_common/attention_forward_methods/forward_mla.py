...
def is_dcp_mla_decode_phase(
    ...
    *,
    physical_draft_cache: bool = False,
) -> bool:
    ...
    return (
        ...
        or (physical_draft_cache and forward_batch.forward_mode.is_draft_extend_v2())
    )
...
class DeepseekMLAForwardMixin:
    ...
    def forward_absorb_prepare(
        ...
        q_replicate_active = (
            ...
            and is_dcp_mla_decode_phase(
                forward_batch, physical_draft_cache=self.use_dsa
            )
    ...
    def forward_absorb_core(
        ...
        if is_dcp_mla_decode_phase(forward_batch, physical_draft_cache=self.use_dsa):
